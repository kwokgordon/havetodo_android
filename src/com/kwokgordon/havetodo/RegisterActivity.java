...
public class RegisterActivity extends Activity {
	...
	private final static String REGISTER_API_ENDPOINT_URL = HaveTodo.HOST_URL + "/api/registrations";
	...
	public void onRegistrationButtonClick(View view) {
		EditText userNameField = (EditText)findViewById(R.id.reg_name);
		...
		EditText userPasswordConfirmationField = (EditText)findViewById(R.id.reg_password_confirmation);
